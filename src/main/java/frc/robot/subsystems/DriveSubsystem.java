...
public class DriveSubsystem extends SubsystemBase {
  ...
  private final SpeedControllerGroup m_leftMotors = new SpeedControllerGroup(leftTalon1, leftTalon2, leftTalon3);

  // The motors on the right side of the drive.
  private final SpeedControllerGroup m_rightMotors = new SpeedControllerGroup(rightTalon1, rightTalon2, rightTalon3);
  ...
  final double kGearRatio = 8.33; // Switch kSensorGearRatio to this gear ratio if encoder is on the motor instead
                                  // of on the gearbox.
  ...
  public void simulationPeriodic() {
    ...
    // move forward.
    m_drivetrainSimulator.setInputs(leftTalon1.getMotorOutputVoltage(), rightTalon1.getMotorOutputVoltage());
    m_drivetrainSimulator.update(0.020);

    m_leftMotorSim.setQuadratureRawPosition(distanceToNativeUnits(m_drivetrainSimulator.getLeftPositionMeters()));
    m_leftMotorSim.setQuadratureVelocity(velocityToNativeUnits(m_drivetrainSimulator.getLeftVelocityMetersPerSecond()));
    m_rightMotorSim.setQuadratureRawPosition(distanceToNativeUnits(m_drivetrainSimulator.getRightPositionMeters()));
    m_rightMotorSim
        .setQuadratureVelocity(velocityToNativeUnits(m_drivetrainSimulator.getRightVelocityMetersPerSecond()));
